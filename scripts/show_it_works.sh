...
echo ""
echo "Starting demonstration in rebar3 shell..."
echo ""
echo "Once in the shell, type:"
echo "  c(test_demo)."
echo "  test_demo:show()."
echo ""

# Start shell
rebar3 shell --eval "io:format(\"~nType: c(test_demo). then test_demo:show().~n~n\")"