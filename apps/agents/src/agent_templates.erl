...
-define(TEMPLATES, #{
    <<"researcher">> => #{
        ...
        model => <<"gpt-4.1">>,
        tools => [jina_search, jina_deep_search, file_read, file_write, knowledge_base_retrieval],
    ...
    <<"coder">> => #{
        ...
        model => <<"gpt-4o">>,
        tools => [shell, file_read, file_write, jina_search],
    ...
    <<"analyst">> => #{
        ...
        model => <<"gpt-4o">>,
        tools => [file_read, file_write, jina_search, knowledge_base_retrieval],
    ...
    <<"orchestrator">> => #{
        ...
        model => <<"gpt-4o">>,
        tools => [create_supervisor, list_supervisors, who_am_i, get_my_peers],
    ...
    <<"monitor">> => #{
        ...
        model => <<"gpt-4o-mini">>,
        tools => [who_am_i, where_am_i, get_my_capabilities],
    ...
    <<"translator">> => #{
        ...
        model => <<"gpt-4o">>,
        tools => [jina_search, jina_read_webpage, file_read, file_write],
    ...
    <<"teacher">> => #{
        ...
        model => <<"gpt-4o">>,
        tools => [knowledge_base_retrieval, jina_search, jina_read_webpage],
    ...
    <<"debugger">> => #{
        ...
        model => <<"gpt-4o">>,
        tools => [shell, file_read, jina_search],
    ...
    <<"quantum_analyst">> => #{
        ...
        model => <<"gpt-4o">>,
        tools => [jina_search, jina_deep_search, knowledge_base_retrieval],
    ...
    <<"api_designer">> => #{
        ...
        model => <<"gpt-4.1-mini">>,
        tools => [file_read, file_write, jina_search],
    ...
    <<"devops_engineer">> => #{
        ...
        model => <<"gpt-4o">>,
        tools => [shell, file_read, file_write, create_supervisor],
    ...
    <<"content_creator">> => #{
        ...
        model => <<"gpt-4o">>,
        tools => [jina_search, jina_read_webpage, file_write],
    ...
    <<"performance_optimizer">> => #{
        ...
        model => <<"gpt-4.1-mini">>,
        tools => [shell, who_am_i, get_my_capabilities],
    ...
    <<"ml_engineer">> => #{
        ...
        model => <<"gpt-4o">>,
        tools => [file_read, file_write, shell, jina_search],
    ...
    <<"cloud_architect">> => #{
        ...
        model => <<"gpt-4o">>,
        tools => [shell, file_read, who_am_i],
    ...
    <<"product_manager">> => #{
        ...
        model => <<"o4-mini">>,
        tools => [jina_search, jina_deep_search, file_write],
    ...
    <<"ai_ethics_advisor">> => #{
        ...
        model => <<"o4-mini">>,
        tools => [jina_search, knowledge_base_retrieval, file_write],
    ...
    <<"systems_architect">> => #{
        ...
        model => <<"gpt-4o">>,
        tools => [file_read, file_write, create_supervisor, list_supervisors],
    ...
    <<"legal_tech_advisor">> => #{
        ...
        model => <<"gpt-4o">>,
        tools => [jina_search, jina_read_webpage, knowledge_base_retrieval],
    ...
    <<"iot_specialist">> => #{
        ...
        model => <<"gpt-4o-mini">>,
        tools => [shell, who_am_i, get_my_peers],
    ...
    <<"quantum_developer">> => #{
        ...
        model => <<"gpt-4o">>,
        tools => [shell, file_read, knowledge_base_retrieval],
    ...
    <<"bioinformatics_analyst">> => #{
        ...
        model => <<"gpt-4o">>,
        tools => [file_read, file_write, knowledge_base_retrieval],
    ...
    <<"accessibility_expert">> => #{
        ...
        model => <<"gpt-4o-mini">>,
        tools => [file_read, jina_read_webpage, file_write],
    ...
    <<"edge_computing_specialist">> => #{
        ...
        model => <<"gpt-4o-mini">>,
        tools => [shell, create_supervisor, who_am_i],
    ...
    <<"digital_twin_architect">> => #{
        ...
        model => <<"gpt-4o">>,
        tools => [file_read, file_write, who_am_i, get_my_peers],
    ...
    <<"voice_ui_designer">> => #{
        ...
        model => <<"gpt-4o-mini">>,
        tools => [jina_search, file_write, knowledge_base_retrieval],
